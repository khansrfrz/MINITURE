       ...
       <div className='mb-10'>
        <div className='header-text'>
          <button className='flex items-center'>
            <div className=' text-white mr-4 common-hover text-4xl rounded-3x1 h-12
         ...
         Creations
         <Link to="/shop" className=' text-white common-hover text-4xl rounded-full ml-4 px-7 py-2'>
         Shop Now
         </Link>
        </div>
       </div>
